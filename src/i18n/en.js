...
export default {
  ...
  mission: {
    ...
    subtitle:
      "Frontend-focused Full-Stack Developer passionate about React, WebGL, and immersive digital experiences.",
    activity: `I specialize in creating dynamic, scalable web applications that merge performance with creativity. 
      From real-time 3D environments to motion-driven landing pages, I turn complex ideas into seamless interactive experiences.`,
    passion: `I’m passionate about combining art and technology to craft engaging experiences. I’m open to opportunities that challenge 
      interactive web development and push creative boundaries.`,
  },
  collaboration: {
  ...
  contact: {
    ...
    message: `Whether you have a project in mind, want to discuss a collaboration, or just want to say hi, 
      feel free to reach out! I respond quickly and love connecting with fellow creatives and developers.`,
    channels: `You can contact me via email at dani@example.com or connect with me on LinkedIn. 
      Let's make interactive experiences that inspire.`,
  },
  work: {
    title: "Showcasing my interactive and 3D web projects.",
    subtitle:
      "From immersive web apps to motion-driven landing pages, here's what I've built.",
    description: `I create dynamic, scalable, and visually engaging web applications. My projects range from real-time 3D environments 
